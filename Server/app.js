...
// Get movie by id
server.get("/movieDetails/:id", function (req, res) {
  var id = +req.params.id;
  var movieDetails = movies.find((movie) => movie.id === id);
  movieDetails
...
// delete movie by id
server.delete("/deleteMovie/:id", function (req, res) {
  var id = +req.params.id;
...
// update movie by id
server.put("/updateMovie/:id", function (req, res) {
  var id = +req.params.id;
  var index = movies.findIndex((movie) => movie.id === id);
  if (index !== -1) {
